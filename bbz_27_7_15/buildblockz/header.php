			...
			$(document).ready(function(){
				$(window).scroll(function() {
				    if ($(".navbar").offset().top > $(window).height()) {
				        $(".navbar-brand img").attr('src','images/buildblockzlogob.png');
				    } else {
				        $(".navbar-brand img").attr('src','images/buildblockzlogow.png');
				    }
				});
			});
		</script>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<div id="pag">
			...
			<?php
				...
				?>
			<nav class="nav_index navbar navbar-custom navbar-fixed-top" role="navigation">
		        <div class="container header_nav">
		            ...
		            <div class="navbar-header">
		                ...
		                <a class="navbar-brand page-scroll" href="index.php">
		                	<img src="images/buildblockzlogow.png" />
		            ...
		            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
		                <ul class="nav navbar-nav">
		                    ...
		                    <li>
		                        <a class="page-scroll" href="buildCalc.php">BuildCalc</a>
		                    </li>
		                    <?php
		                    }else{
		                    ?>
		                    ...
		                    <li>
		                        <a class="page-scroll" href="#contact">BuildCalc</a>
		                    </li>
		                    <?php
		                    	}
		                    ?>
